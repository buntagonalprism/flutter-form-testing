...
class ValidatorSet<T> {
  ...
  Map<String, dynamic> call(AbstractControl<T> control) {
    ...
    for (var validator in _validators) {
      errors.addAll(validator.validate(control.value));
    }
    return errors;
  }
...
class Control<T> extends AbstractControl<T> {
  ...
  Control([dynamic value, ValidatorSet<T> validator])
...
class ControlGroup extends AbstractControlGroup<Map<String, dynamic>> {
  ControlGroup(Map<String, AbstractControl> controls, [ValidatorSet validator])
...
abstract class AbstractControlGroup<T> extends AbstractControl<T> {
  ...
  AbstractControlGroup(this.controls, [ValidatorSet<T> validator])
      : super(validator) {
...
class ControlArray extends AbstractControl<List> {
  ...
  ControlArray(this.controls, [ValidatorSet validator]) : super(validator) {
